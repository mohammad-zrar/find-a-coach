<template>
  <form @submit.prevent="submitForm">
    ...
    <div :class="{ invalid: !firstName.isValid }" class="form-control">
      ...
      <!-- @blur is built in event which is triggered whenever it loses focus -->
    ...
    <div :class="{ invalid: !areas.isValid }" class="form-control">
      ...
      <div>
        <input type="checkbox" id="baclemd" value="backend" v-model="areas.val" @blur="clearValidity('areas')" />
